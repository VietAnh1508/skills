...
| [list-skills](./list-skills/SKILL.md)              | `/list-skills`    | Lists all AI agent skills installed on this machine across providers: Claude Code, Claude Desktop, Gemini CLI, and OpenAI Codex CLI. Also scans project dirs for Cursor rules and AGENTS.md files. |
